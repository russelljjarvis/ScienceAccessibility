...
We used a computer, to check writing to see how hard it is to understand lots of different writing, meant for different people. we want to stop a thing happening again, that happens often. We want to stop people not reading hard ideas, only because there were too many hard words.
