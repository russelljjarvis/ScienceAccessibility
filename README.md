...
We used a computer, to check writing to see how hard it is to understand lots of different writing, meant for different people. we want to stop a often happening thing, happening again. We want to stop people avoiding reading hard ideas, only because there were too many hard words.
