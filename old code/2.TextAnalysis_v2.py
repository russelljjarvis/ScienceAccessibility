...
numURLs = 2 #number of URLs per search website 
...
for b in range(0,web) :
    ...
    for p in range(0,numURLs) :
        ...
        urlDat[3,2] = fdist[term.lower()] #frequency of search term    
...
#save
sio.savemat('textData_' + str(term) + '.mat', {'obj_arr':obj_arr})
