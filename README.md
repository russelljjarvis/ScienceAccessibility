...
## Overview 
Non-scientific writing typically exceeds genuine scientific writing in one important aspect: in contrast to genuine science non-science ideas are often expressed with a less complex, and more engadging writing style. We believe non-science writing occupies a more accessible style niche, that academic science writing should also occupy. Unfortunately, writing styles intended for different audiances, are predictbley different. We show that we can use machine learning to predict the status of writing styles: popular culture, opinionative, and traditional science, by first sampling a large variety of web documents, and then classifying among the different writing types. By predicting which of the several different styles a document occupies, we are able to characterize among different writing niches, and to point to remedies.
