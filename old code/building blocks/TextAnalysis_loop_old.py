...
num = 3 #number of URLs per search website + 1
...
for p in range(1,num) :
    ...
    if p == 1:
        ...
        obj_arr_add = np.array([numWords, numSents, WperS, sentSyl, frexTop, fM, frexTerm, PS, SA], dtype=object)
